...
BEFORE YOU GO LIVE — CHECKLIST
  1. Partner directory in partners.html is EMPTY, waiting for real data.
     The PARTNERS array sits at the top of the <script> block at the
     bottom of the file with a comment explaining each field. Add one
     object per signed business; the four "Your business here" cards are
     placeholders — delete them as real partners come in.
  2. Same for the brand wall in index.html (section id="brands"), which is
     plain HTML: eight "Your brand here" tiles to be replaced by name.
  ...
  4. Event dates and venues live in the SHOWS array at the bottom of
     index.html. Edition 01 is Thursday 10 September 2026 in Riyadh;
     the season follows on Thursdays — 8 October, 12 November,
     10 December. Update as venues are contracted.
